...
myTest(def, cplex,"i-manual-32-132-100-20171206_21-22-32.dat", logname, "SUCCESS", 1 );
myTest(def, cplex,"i-manual-31-131-100-20171206_21-22-32.dat", logname, "SUCCESS", 1 );
var ofile = new IloOplOutputFile(logname, true);
