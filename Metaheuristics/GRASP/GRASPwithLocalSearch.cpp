...
class GRASPwithLocalSearch: public SolutionMethod {
    private:
        int RCLsize;
...
GRASPwithLocalSearch::ConstructiveGRASP(NurseSchedulingProblem* problem, int RCLsize, int maxIterations) {
...
void GRASPwithLocalSearch::performSearch() {
    int iteration = 0;
...
NurseSchedulingSolution* GRASPwithLocalSearch::constructSolution(float alpha) {
...
NurseSchedulingSolution* GRASPwithLocalSearch::localSearch(NurseSchedulingSolution* solution) {
    bool update = true;
...
std::vector<CandidateAssignment> GRASPwithLocalSearch::updateCandidatesSet(NurseSchedulingSolution* solution, std::vector<CandidateAssignment> candidates) {
...
std::vector<CandidateAssignment> GRASPwithLocalSearch::initializeCandidatesSet() {
...
std::vector<CandidateAssignment> GRASPwithLocalSearch::createAssignmentsNotInSolution(NurseSchedulingSolution* solution) {
...
double GRASPwithLocalSearch::computeGreedyCost(int nurse, int hour, bool state) {
